---
title: "Cross-Contract Verification Guide"
description: "How to securely call the Soroban-ZK-Std verifier from an external dApp contract"
protocol: "25"
cap: "CAP-0075"
---
...
- [Getting Started Guide](./getting-started-guide.mdx) — set up a contract from scratch
- [GAS.md](../GAS.md) — instruction cost reference for budget planning
- [ASP Integration Guide](./ASP_Integration.mdx) — compliance workflow with cross-contract verifiers
